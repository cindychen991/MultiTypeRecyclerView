 ...
 * @date 2018/9/26
 */
class ItemThreeAdapter : BaseCellAdapter<ItemTwo, ItemThreeAdapter.Companion.ViewHolder>() {


    override fun createHolderHelper(parent: ViewGroup): ViewHolder {
        return ViewHolder(adapter.mInflater.inflate(R.layout.layout_item_three, parent, false))
    }
